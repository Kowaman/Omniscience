...
public interface DisplayHandler {
     ...
     * <p>
     * This method will be provided the value that is stored in a {@link net.lordofthecraft.omniscience.api.data.DataWrapper}
     * with the {@link net.lordofthecraft.omniscience.api.data.DataKey}
     * of {@link net.lordofthecraft.omniscience.api.data.DataKeys#DISPLAY_METHOD}. This is done so that we can be robust and selective about when these handlers are used.
     * </p>
     *
