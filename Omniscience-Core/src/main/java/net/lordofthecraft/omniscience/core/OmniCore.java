...
import net.lordofthecraft.omniscience.api.OmniscienceProvider;
...
import net.lordofthecraft.omniscience.core.agnostic.BukkitActor;
import net.lordofthecraft.omniscience.core.api.entry.BlockEntry;
import net.lordofthecraft.omniscience.core.api.entry.ContainerEntry;
import net.lordofthecraft.omniscience.core.api.entry.EntityEntry;
import net.lordofthecraft.omniscience.core.api.entry.EntryQueueRunner;
import net.lordofthecraft.omniscience.core.api.entry.entrybuilder.BukkitEventBuilder;
import net.lordofthecraft.omniscience.core.api.entry.entrybuilder.BukkitSourceBuilder;
import net.lordofthecraft.omniscience.core.api.flag.*;
import net.lordofthecraft.omniscience.core.api.parameter.*;
import net.lordofthecraft.omniscience.core.command.OmniscienceCommand;
import net.lordofthecraft.omniscience.core.command.OmniscienceTabCompleter;
import net.lordofthecraft.omniscience.core.command.util.OmniTeleCommand;
import net.lordofthecraft.omniscience.core.io.StorageHandler;
import net.lordofthecraft.omniscience.core.listener.CraftBookSignListener;
import net.lordofthecraft.omniscience.core.listener.PluginInteractionListener;
import net.lordofthecraft.omniscience.core.listener.WandInteractListener;
...
final class OmniCore implements IOmniscience {
    ...
    @Override
    public EventBuilder createLogBuilder(Object source) {
        return new BukkitEventBuilder(new BukkitSourceBuilder(source));
    }

    @Override
    public Actor wrapActor(UUID actorId) {
        return new BukkitActor(Bukkit.getOfflinePlayer(actorId));
    }
